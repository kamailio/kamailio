...
IUSE="ipv6 mysql radius postgres jabber ssl odbc sctp redis pua ims presence sqlite snmp json http ldap geoip2 erlang xml jansson lua evapi"

DESCRIPTION="Kamailio - The Open Source SIP Server for large VoIP and real-time communication platforms"
...
src_configure() {
	...
	use presence && KAMODULES="${KAMODULES} presence presence_conference presence_dfks presence_dialoginfo presence_mwi presence_profile presence_reginfo presence_xml"

...
static int sca_call_info_invite_reply_200_handler(sip_msg_t *msg,
	...
	if (SCA_CALL_INFO_IS_SHARED_CALLEE(call_info) && (!SCA_STR_EQ(from_aor, to_aor))) {
...
struct sca_call_info_dispatch call_info_dispatch[] = { { METHOD_BYE,
		sca_call_info_bye_handler }, { METHOD_CANCEL,
		sca_call_info_cancel_handler }, { METHOD_INVITE,
		sca_call_info_invite_handler }, { METHOD_PRACK,
		sca_call_info_prack_handler }, { METHOD_REFER,
		sca_call_info_refer_handler }, };

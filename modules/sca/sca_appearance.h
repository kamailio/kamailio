 ...
 */
enum {
	SCA_APPEARANCE_STATE_SEIZED_TTL = 120, /* Polycoms aggressively resubscribe line-seizes, give them time */
	SCA_APPEARANCE_STATE_PENDING_TTL = 35, /* enough time to allow retransmissions (~32s) */
};
...
struct _sca_appearance_times {
	time_t ctime; /* time of appearance creation */
	time_t mtime; /* time of last appearance state change */
	time_t atime; /* time of last end-to-end activity */

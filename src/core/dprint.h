...
#define L_MAX 3
#define L_OFFSET \
	42 /* needs to be added and then substracted
...
#define LOGV_FUNCSUFFIX_STR(vfuncname) \
	(((void *)vfuncname != NULL) ? _FUNC_SUFFIX_ : "")
...
#define LOG_LN(level, lname, ...) \
	LOG_FL(DEFAULT_FACILITY, (level), (lname), LOC_INFO, __VA_ARGS__, NULL)
#define LOG(level, ...) \

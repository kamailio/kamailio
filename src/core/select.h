...
#define SELECT_F(function) \
	extern int function(str *res, select_t *s, struct sip_msg *msg);
#define ABSTRACT_F(function)                                 \
	int function(str *res, select_t *s, struct sip_msg *msg) \
	{                                                        \
		return -1;                                           \
	}

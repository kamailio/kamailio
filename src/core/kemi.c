...
static int sr_kemi_core_match_method_id(str *rmethod, str *vmethod, int mid)
{
	...
	if((method == METHOD_UNDEF) || (method & METHOD_OTHER)) {
		LM_ERR("unknown method in list [%.*s] - use only standard SIP "
			   "methods\n",
				s.len, s.s);
		return SR_KEMI_FALSE;
	}
...
{
	if(msg == NULL || vmethod == NULL || vmethod->s == NULL
			|| vmethod->len <= 0) {
	...
	if(get_cseq(msg)->method_id == METHOD_OTHER) {
		...
		if(strncasecmp(get_cseq(msg)->method.s, vmethod->s, vmethod->len)
				!= 0) {
			return SR_KEMI_FALSE;
		}
		return SR_KEMI_TRUE;
	}
	return sr_kemi_core_match_method_id(
			&get_cseq(msg)->method, vmethod, get_cseq(msg)->method_id);
}
...
static int sr_kemi_core_is_af_ipv4(sip_msg_t *msg)
{
	...
	return (msg->rcv.bind_address->address.af == AF_INET) ? SR_KEMI_TRUE
														  : SR_KEMI_FALSE;
}
...
static int sr_kemi_core_is_af_ipv6(sip_msg_t *msg)
{
	...
	return (msg->rcv.bind_address->address.af == AF_INET6) ? SR_KEMI_TRUE
														   : SR_KEMI_FALSE;
}
...
static int sr_kemi_core_is_dst_port(sip_msg_t *msg, int vport)
{
	...
	return (vport == (int)msg->rcv.bind_address->port_no) ? SR_KEMI_TRUE
														  : SR_KEMI_FALSE;
}
...
static int sr_kemi_core_add_tcp_alias_via(sip_msg_t *msg)
{
	...
	if(msg->rcv.proto == PROTO_TCP
		...
		if(tcpconn_add_alias(
				   msg->rcv.proto_reserved1, msg->via1->port, msg->rcv.proto)
				!= 0) {
			LM_ERR("adding tcp alias failed\n");
			return SR_KEMI_FALSE;
		}
...
static sr_kemi_t _sr_kemi_core[] = {
		{str_init(""), str_init("dbg"), SR_KEMIP_NONE, sr_kemi_core_dbg,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("err"), SR_KEMIP_NONE, sr_kemi_core_err,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("info"), SR_KEMIP_NONE, sr_kemi_core_info,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("warn"), SR_KEMIP_NONE, sr_kemi_core_warn,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("notice"), SR_KEMIP_NONE, sr_kemi_core_notice,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("crit"), SR_KEMIP_NONE, sr_kemi_core_crit,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("log"), SR_KEMIP_NONE, sr_kemi_core_log,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_drop"), SR_KEMIP_NONE,
				sr_kemi_core_set_drop,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_ruri"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_ruri,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_duri"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_duri,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_nhuri"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_nhuri,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_furi"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_furi,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_turi"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_turi,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_suri"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_suri,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_myself_srcip"), SR_KEMIP_BOOL,
				sr_kemi_core_is_myself_srcip,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("setflag"), SR_KEMIP_BOOL, sr_kemi_core_setflag,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("resetflag"), SR_KEMIP_BOOL,
				sr_kemi_core_resetflag,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("isflagset"), SR_KEMIP_BOOL,
				sr_kemi_core_isflagset,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("setbflag"), SR_KEMIP_BOOL,
				sr_kemi_core_setbflag,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("resetbflag"), SR_KEMIP_BOOL,
				sr_kemi_core_resetbflag,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("isbflagset"), SR_KEMIP_BOOL,
				sr_kemi_core_isbflagset,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("setbiflag"), SR_KEMIP_BOOL,
				sr_kemi_core_setbiflag,
				{SR_KEMIP_INT, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("resetbiflag"), SR_KEMIP_BOOL,
				sr_kemi_core_resetbiflag,
				{SR_KEMIP_INT, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("isbiflagset"), SR_KEMIP_BOOL,
				sr_kemi_core_isbiflagset,
				{SR_KEMIP_INT, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("setsflag"), SR_KEMIP_BOOL,
				sr_kemi_core_setsflag,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("resetsflag"), SR_KEMIP_BOOL,
				sr_kemi_core_resetsflag,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("issflagset"), SR_KEMIP_BOOL,
				sr_kemi_core_issflagset,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("seturi"), SR_KEMIP_BOOL, sr_kemi_core_seturi,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("setuser"), SR_KEMIP_BOOL, sr_kemi_core_setuser,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("sethost"), SR_KEMIP_BOOL, sr_kemi_core_sethost,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("setdsturi"), SR_KEMIP_BOOL,
				sr_kemi_core_setdsturi,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("resetdsturi"), SR_KEMIP_BOOL,
				sr_kemi_core_resetdsturi,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("isdsturiset"), SR_KEMIP_BOOL,
				sr_kemi_core_isdsturiset,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("force_rport"), SR_KEMIP_BOOL,
				sr_kemi_core_force_rport,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("add_local_rport"), SR_KEMIP_BOOL,
				sr_kemi_core_add_local_rport,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_method"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_method_in"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_in,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("forward"), SR_KEMIP_INT, sr_kemi_core_forward,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("forward_uri"), SR_KEMIP_INT,
				sr_kemi_core_forward_uri,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_forward_close"), SR_KEMIP_BOOL,
				sr_kemi_core_set_forward_close,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_forward_no_connect"), SR_KEMIP_BOOL,
				sr_kemi_core_set_forward_no_connect,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_reply_close"), SR_KEMIP_BOOL,
				sr_kemi_core_set_reply_close,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_reply_no_connect"), SR_KEMIP_BOOL,
				sr_kemi_core_set_reply_no_connect,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_advertised_address"), SR_KEMIP_INT,
				sr_kemi_core_set_advertised_address,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("set_advertised_port"), SR_KEMIP_INT,
				sr_kemi_core_set_advertised_port,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("add_tcp_alias"), SR_KEMIP_INT,
				sr_kemi_core_add_tcp_alias,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("add_tcp_alias_via"), SR_KEMIP_INT,
				sr_kemi_core_add_tcp_alias_via,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_INVITE"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_invite,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_ACK"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_ack,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_BYE"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_bye,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_CANCEL"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_cancel,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_REGISTER"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_register,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_OPTIONS"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_options,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_SUBSCRIBE"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_subscribe,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_PUBLISH"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_publish,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_NOTIFY"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_notify,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_REFER"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_refer,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_INFO"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_info,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_UPDATE"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_update,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_PRACK"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_prack,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_MESSAGE"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_message,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_KDMQ"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_kdmq,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_GET"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_get,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_POST"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_post,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_PUT"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_put,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_DELETE"), SR_KEMIP_BOOL,
				sr_kemi_core_is_method_delete,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_UDP"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_udp,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_TCP"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_tcp,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_TLS"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_tls,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_WS"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_ws,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_WSS"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_wss,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_WSX"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_wsx,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_SCTP"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto_sctp,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_proto"), SR_KEMIP_BOOL,
				sr_kemi_core_is_proto,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_IPv4"), SR_KEMIP_BOOL,
				sr_kemi_core_is_af_ipv4,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_IPv6"), SR_KEMIP_BOOL,
				sr_kemi_core_is_af_ipv6,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_UDP"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_udp,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_TCP"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_tcp,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_TLS"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_tls,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_SCTP"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_sctp,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_WS"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_ws,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_WSS"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_wss,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_WSX"), SR_KEMIP_BOOL,
				sr_kemi_core_to_proto_wsx,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_IPv4"), SR_KEMIP_BOOL,
				sr_kemi_core_to_af_ipv4,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("to_IPv6"), SR_KEMIP_BOOL,
				sr_kemi_core_to_af_ipv6,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_src_port"), SR_KEMIP_BOOL,
				sr_kemi_core_is_src_port,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("is_dst_port"), SR_KEMIP_BOOL,
				sr_kemi_core_is_dst_port,
				{SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("get_debug"), SR_KEMIP_INT,
				sr_kemi_core_get_debug,
				{SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init(""), str_init("route"), SR_KEMIP_INT, sr_kemi_core_route,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
...
static int sr_kemi_hdr_append_after(sip_msg_t *msg, str *txt, str *hname)
{
	...
	if(txt == NULL || txt->s == NULL || hname == NULL || hname->s == NULL
			|| msg == NULL)
		return -1;
 ...
 *
 */
static sr_kemi_xval_t *sr_kemi_hdr_get_mode(
		sip_msg_t *msg, str *hname, int idx, int rmode)
{
	hdr_field_t shdr;
	hdr_field_t *ihdr;
 ...
 *
 */
static int sr_kemi_hdr_match_content(
		sip_msg_t *msg, str *hname, str *op, str *mval, str *hidx)
{
	hdr_field_t *hf;
	hdr_field_t hfm;
	int opval = 0;
...
static sr_kemi_t _sr_kemi_hdr[] = {
		{str_init("hdr"), str_init("append"), SR_KEMIP_INT, sr_kemi_hdr_append,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("append_after"), SR_KEMIP_INT,
				sr_kemi_hdr_append_after,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("insert"), SR_KEMIP_INT, sr_kemi_hdr_insert,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("insert_before"), SR_KEMIP_INT,
				sr_kemi_hdr_insert_before,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("remove"), SR_KEMIP_INT, sr_kemi_hdr_remove,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("rmappend"), SR_KEMIP_INT,
				sr_kemi_hdr_rmappend,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("rminsert"), SR_KEMIP_INT,
				sr_kemi_hdr_rminsert,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("is_present"), SR_KEMIP_INT,
				sr_kemi_hdr_is_present,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("append_to_reply"), SR_KEMIP_INT,
				sr_kemi_hdr_append_to_reply,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("get"), SR_KEMIP_XVAL, sr_kemi_hdr_get,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("gete"), SR_KEMIP_XVAL, sr_kemi_hdr_gete,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("getw"), SR_KEMIP_XVAL, sr_kemi_hdr_getw,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("get_idx"), SR_KEMIP_XVAL,
				sr_kemi_hdr_get_idx,
				{SR_KEMIP_STR, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("gete_idx"), SR_KEMIP_XVAL,
				sr_kemi_hdr_gete_idx,
				{SR_KEMIP_STR, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("getw_idx"), SR_KEMIP_XVAL,
				sr_kemi_hdr_getw_idx,
				{SR_KEMIP_STR, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("hdr"), str_init("match_content"), SR_KEMIP_BOOL,
				sr_kemi_hdr_match_content,
...
{
	if(xval
			&& (xval->vtype == SR_KEMIP_ARRAY
					|| xval->vtype == SR_KEMIP_DICT)) {
 ...
 *
 */
static void sr_kemi_pv_push_valx(
		sr_kemi_xval_t *xval, int rmode, int vi, str *vs)
{
	if(rmode == 1) {
		xval->vtype = SR_KEMIP_INT;
		xval->v.n = vi;
 ...
 *
 */
static sr_kemi_xval_t *sr_kemi_pv_get_valx(
		sip_msg_t *msg, str *pvn, str *xsval, int xival, int rmode)
{
	pv_spec_t *pvs;
	pv_value_t val;
	int pl;
...
static sr_kemi_t _sr_kemi_pv[] = {
		{str_init("pv"), str_init("get"), SR_KEMIP_XVAL, sr_kemi_pv_get,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("getw"), SR_KEMIP_XVAL, sr_kemi_pv_getw,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("gete"), SR_KEMIP_XVAL, sr_kemi_pv_gete,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("geti"), SR_KEMIP_INT, sr_kemi_pv_geti,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("getl"), SR_KEMIP_XVAL, sr_kemi_pv_getl,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("getvn"), SR_KEMIP_XVAL, sr_kemi_pv_getvn,
				{SR_KEMIP_STR, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("getvs"), SR_KEMIP_XVAL, sr_kemi_pv_getvs,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("seti"), SR_KEMIP_BOOL, sr_kemi_pv_seti,
				{SR_KEMIP_STR, SR_KEMIP_INT, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("setl"), SR_KEMIP_BOOL, sr_kemi_pv_setl,
				{SR_KEMIP_STR, SR_KEMIP_LONG, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("sets"), SR_KEMIP_BOOL, sr_kemi_pv_sets,
				{SR_KEMIP_STR, SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("unset"), SR_KEMIP_BOOL, sr_kemi_pv_unset,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
		{str_init("pv"), str_init("is_null"), SR_KEMIP_BOOL, sr_kemi_pv_is_null,
				{SR_KEMIP_STR, SR_KEMIP_NONE, SR_KEMIP_NONE, SR_KEMIP_NONE,
						SR_KEMIP_NONE, SR_KEMIP_NONE}},
...
int sr_kemi_modules_add(sr_kemi_t *klist)
{
	...
	if((_sr_kemi_modules_size > 1)
			...
			&& (strncmp(_sr_kemi_modules[_sr_kemi_modules_size - 1].mname.s,
						klist[0].mname.s, klist[0].mname.len)
					== 0)) {
	...
	if(mname == NULL || mname->len <= 0) {
		...
		if(midx > 0 && midx < SR_KEMI_MODULES_MAX_SIZE) {
			for(i = 0; _sr_kemi_modules[midx].kexp[i].fname.s != NULL; i++) {
				...
				if(ket->fname.len == fname->len
						&& strncasecmp(ket->fname.s, fname->s, fname->len)
								   == 0) {
					return ket;
				}
			}
...
int sr_kemi_eng_register(str *ename, sr_kemi_eng_route_f froute)
{
	...
	for(i = 0; i < _sr_kemi_eng_list_size; i++) {
		if(_sr_kemi_eng_list[i].ename.len == ename->len
				&& strncasecmp(
						   _sr_kemi_eng_list[i].ename.s, ename->s, ename->len)
						   == 0) {
			/* found */
			return 1;
		}
	...
	strncpy(_sr_kemi_eng_list[_sr_kemi_eng_list_size].bname, ename->s,
			ename->len);
...
int sr_kemi_cbname_lookup_name(str *name)
{
	...
	for(i = 0; i < n; i++) {
		if(_sr_kemi_cbname_list[i].name.len == name->len
				&& strncmp(_sr_kemi_cbname_list[i].name.s, name->s, name->len)
						   == 0) {
			return i + 1;
		}
	}
...
#define KEMI_PARAM_MAP_SIZE 72
	...
	if(pbuf[0] == '\0') {
		...
		if(pn == NULL)
			return NULL;
		if(pn->len < KEMI_PARAM_MAP_SIZE - 1)
			strncat(pbuf, pn->s, pn->len);
	}
done:
	sret.s = pbuf;

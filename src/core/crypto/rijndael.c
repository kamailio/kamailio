...
void aes_set_key(
		rijndael_ctx *ctx, const u_int8_t *key, unsigned keybits, int enc)
{
	u_int32_t *k;
...
void aes_cbc_encrypt(
		rijndael_ctx *ctx, u_int8_t *iva, u_int8_t *data, unsigned len)
{
...
static void show256u8(char *name, u_int8_t *data)
{
	int i;
...
static void show4x256u32(char *name, u_int32_t data[4][256])
{
	int i, j;

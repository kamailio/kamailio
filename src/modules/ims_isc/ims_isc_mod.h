...
enum isc_mark_status {
	ISCMARK_FOUND_ROUTE_HEADER = 0, /*Request has been received from AS, old ISCMARK found in Route header field*/
	ISCMARK_FOUND_LUMPS = 1, /*Request to AS has been rejected or timed out, old ISCMARK found in lumps*/
	ISCMARK_MISSING_START_TRIGGERING = 2, /*Request has been received without old ISCMARK in Route header field*/
	ISCMARK_MISSING_START_TRIGGERING_SAR = 3 /*SAR/SAA has happened with HSS, due to terminating request (no old ISCMARK)*/
};

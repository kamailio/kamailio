 ...
 */
typedef auth_result_t (*post_auth_t)(
		struct sip_msg *msg, struct hdr_field *hdr, char *ha1);
...
typedef int (*auth_challenge_hftype_f)(
...
typedef struct auth_api_s
{
	...
	build_challenge_hf_t
			build_challenge; /* Function to build digest challenge header */

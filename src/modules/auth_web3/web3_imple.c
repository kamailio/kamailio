...
int auth_web3_check_response(dig_cred_t *cred, str *method) {
  ...
  call_data = (char *)pkg_malloc(total_hex_chars + 1); /* +1 for null terminator */
  if (!call_data) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064" PRIx64, (uint64_t)offset1);
    if (ret < 0 || (size_t)ret >= remaining) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064" PRIx64, (uint64_t)offset2);
    if (ret < 0 || (size_t)ret >= remaining) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064" PRIx64, (uint64_t)offset3);
    if (ret < 0 || (size_t)ret >= remaining) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064" PRIx64, (uint64_t)offset4);
    if (ret < 0 || (size_t)ret >= remaining) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064" PRIx64, (uint64_t)offset5);
    if (ret < 0 || (size_t)ret >= remaining) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064" PRIx64, (uint64_t)offset7);
    if (ret < 0 || (size_t)ret >= remaining) {
  ...
  {
    size_t remaining = total_hex_chars + 1 - pos;
    ret = snprintf(call_data + pos, remaining, "%064x",
                    (unsigned int)actual_byte_len);
    if (ret < 0 || (size_t)ret >= remaining) {

...
set(MOD_LIST_BASIC async auth benchmark blst cfg_rpc cfgutils corex counters 
...
set(MOD_LIST_EXTRA avp auth_diameter call_control call_obj dmq domainpolicy msrp 
...
set(MOD_LIST_DB acc alias_db auth_db avpops cfg_db db_text db_flatstore 
...
set(MOD_LIST_PRESENCE presence presence_conference presence_dialoginfo 
...
set(MOD_LIST_IMS cdp cdp_avp ims_dialog ims_auth ims_isc ims_icscf ims_qos 
...
# - all modules
set(MOD_LIST_ALL ${MOD_LIST_BASIC} ${MOD_LIST_EXTRA} ${MOD_LIST_DB} ${MOD_LIST_DBUID} 
                ${MOD_LIST_DEVEL} ${MOD_LIST_PCRE} ${MOD_LIST_RADIUS} ${MOD_LIST_LDAP} 
                ${MOD_LIST_MYSQL} ${MOD_LIST_POSTGRES} ${MOD_LIST_UNIXODBC} ${MOD_LIST_XMLDEPS} 
                ${MOD_LIST_PERLDEPS} ${MOD_LIST_CPLC} ${MOD_LIST_XMPP} ${MOD_LIST_BERKELEY} 
                ${MOD_LIST_UTILS} ${MOD_LIST_MEMCACHED} ${MOD_LIST_TLSDEPS} ${MOD_LIST_WEBSOCKET} 
                ${MOD_LIST_SNMPSTATS} ${MOD_LIST_PRESENCE} ${MOD_LIST_LUA} ${MOD_LIST_PYTHON} 
                ${MOD_LIST_PYTHON3} ${MOD_LIST_RUBY} ${MOD_LIST_GEOIP} ${MOD_LIST_SQLITE} 
                ${MOD_LIST_JSON} ${MOD_LIST_JSON_EVENT} ${MOD_LIST_REDIS} ${MOD_LIST_MONO} 
                ${MOD_LIST_IMS} ${MOD_LIST_CASSANDRA} ${MOD_LIST_ORACLE} ${MOD_LIST_OUTBOUND} 
                ${MOD_LIST_OSP} ${MOD_LIST_JAVA} ${MOD_LIST_DNSSEC} ${MOD_LIST_SCTP} 
                ${MOD_LIST_AUTHEPH} ${MOD_LIST_GZCOMPRESS} ${MOD_LIST_UUID} ${MOD_LIST_EV} 
                ${MOD_LIST_KAZOO} ${MOD_LIST_MONGODB} ${MOD_LIST_CNXCC} ${MOD_LIST_JANSSON} 
                ${MOD_LIST_JANSSON_EVENT} ${MOD_LIST_GEOIP2} ${MOD_LIST_ERLANG} ${MOD_LIST_SYSTEMD} 
                ${MOD_LIST_HTTP_ASYNC} ${MOD_LIST_NSQ} ${MOD_LIST_RABBITMQ} ${MOD_LIST_JSDT}
                ${MOD_LIST_PHONENUM} ${MOD_LIST_KAFKA} ${MOD_LIST_MQTT} ${MOD_LIST_NATS}
                ${MOD_LIST_RUXC} ${MOD_LIST_SECSIPID} ${MOD_LIST_JWT} ${MOD_LIST_LWSC}
                ${MOD_LIST_STIRSHAKEN} ${MOD_LIST_TLSA} ${MOD_LIST_TLS_WOLFSSL} ${MOD_LIST_MICROHTTPD}
                ${MOD_LIST_NGHTTP2} ${MOD_LIST_GCRYPT} ${MOD_LIST_RTP_MEDIA_SERVER}
                )
...
# 					$(mod_list_tlsdeps)
set(MODULE_GROUP_COMMON ${MOD_LIST_DB} ${MOD_LIST_DBUID} ${MOD_LIST_PCRE} 
                       ${MOD_LIST_RADIUS} ${MOD_LIST_XMLDEPS} ${MOD_LIST_PRESENCE} 
                       ${MOD_LIST_TLSDEPS}
)

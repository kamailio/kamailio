...
counter_def_t sctp_cnt_defs[] = {
		...
		{0, "current_opened_connections", 0, sctp_info,
				(void *)(long)SCTP_INFO_CONN_NO,
				"number of currently opened associations."},
		{0, "current_tracked_connections", 0, sctp_info,
				(void *)(long)SCTP_INFO_TRACKED_NO,

...
int sql_do_xquery(
		sip_msg_t *msg, sql_con_t *con, pv_elem_t *query, pv_elem_t *res);
int sql_do_pvquery(
		sip_msg_t *msg, sql_con_t *con, pv_elem_t *query, pvname_list_t *res);
int pv_get_sqlrows(sip_msg_t *msg, pv_param_t *param, pv_value_t *res);
...
typedef int (*sqlops_do_xquery_f)(
		sip_msg_t *msg, str *scon, str *squery, str *sxavp);

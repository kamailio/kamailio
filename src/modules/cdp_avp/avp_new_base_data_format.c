...
inline AAA_AVP *cdp_avp_new_Integer32(
		int avp_code, int avp_flags, int avp_vendorid, int32_t data)
{
	...
	set_4bytes(x, data);
	return cdp_avp_new(
			avp_code, avp_flags, avp_vendorid, s, AVP_DUPLICATE_DATA);
}


inline AAA_AVP *cdp_avp_new_Integer64(
...
inline AAA_AVP *cdp_avp_new_Unsigned32(
...
inline AAA_AVP *cdp_avp_new_Unsigned64(
...
inline AAA_AVP *cdp_avp_new_Float32(
		int avp_code, int avp_flags, int avp_vendorid, float data)
{
	uint32_t udata;
	memcpy(&udata, &data, sizeof(uint32_t));
	return cdp_avp_new_Unsigned32(avp_code, avp_flags, avp_vendorid,
			udata); //TODO - check if this is correct
}

inline AAA_AVP *cdp_avp_new_Float64(
		int avp_code, int avp_flags, int avp_vendorid, double data)
{
	uint64_t udata;
	memcpy(&udata, &data, sizeof(uint32_t));
	return cdp_avp_new_Unsigned64(avp_code, avp_flags, avp_vendorid,
			udata); //TODO - check if this is correct
}
 ...
 * @return
 */
inline AAA_AVP *cdp_avp_new_Grouped(int avp_code, int avp_flags,
		int avp_vendorid, AAA_AVP_LIST *list, AVPDataStatus list_do)
{
	str grp;
	if(!list) {
	...
	if(!grp.len) {
		LOG(L_ERR,
				"The AAA_AVP_LIST provided was empty! (AVP Code %d VendorId "
				"%d)\n",
		...
		int avp_code, int avp_flags, int avp_vendorid, ip_address data)
{
	...
	switch(data.ai_family) {
		...
		default:
			LOG(L_ERR,
					"Unimplemented for ai_family %d! (AVP Code %d Vendor-Id "
					"%d)\n",
...
inline AAA_AVP *cdp_avp_new_Time(
...
inline AAA_AVP *cdp_avp_new_UTF8String(int avp_code, int avp_flags,
		int avp_vendorid, str data, AVPDataStatus data_do)
{
	return cdp_avp_new(avp_code, avp_flags, avp_vendorid, data, data_do);
}

inline AAA_AVP *cdp_avp_new_DiameterIdentity(int avp_code, int avp_flags,
		int avp_vendorid, str data, AVPDataStatus data_do)
{
	return cdp_avp_new(avp_code, avp_flags, avp_vendorid, data, data_do);
}

inline AAA_AVP *cdp_avp_new_DiameterURI(int avp_code, int avp_flags,
		int avp_vendorid, str data, AVPDataStatus data_do)
{
	return cdp_avp_new(avp_code, avp_flags, avp_vendorid, data, data_do);
}

inline AAA_AVP *cdp_avp_new_Enumerated(
		int avp_code, int avp_flags, int avp_vendorid, int32_t data)
{
	char x[4];
	str s = {x, 4};
...
inline AAA_AVP *cdp_avp_new_IPFilterRule(int avp_code, int avp_flags,
		int avp_vendorid, str data, AVPDataStatus data_do)
{
	return cdp_avp_new(avp_code, avp_flags, avp_vendorid, data, data_do);
}

inline AAA_AVP *cdp_avp_new_QoSFilterRule(int avp_code, int avp_flags,
		int avp_vendorid, str data, AVPDataStatus data_do)
{
	return cdp_avp_new(avp_code, avp_flags, avp_vendorid, data, data_do);
}

...
//module parameters
char *ims_icscf_db_url =
		"mysql://username:password@localhost/kamailio"; /**< DB URL */
...
char *ims_icscf_db_capabilities_table =
		"s_cscf_capabilities"; /**< S-CSCF capabilities table in db */

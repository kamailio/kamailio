...
#define MSG_400_NO_PUBLIC_FROM \
	"Bad Request - Public ID in P-Asserted-Identity or From header missing"
#define MSG_400_NO_PUBLIC \
	"Bad Request - Public ID in To header or Request-URI missing"
#define MSG_400_NO_PRIVATE \
	"Bad Request - Private ID in Authorization / username token missing"
#define MSG_400_MALFORMED_CONTACT \
	"Bad Request - Error parsing Contact parameters"
#define MSG_400_NO_VISITED "Bad Request - P-Visited-Network-ID header missing"

#define MSG_500_UNKOWN_EXPERIMENTAL_RC \
...
#define MSG_403_IDENTITY_NOT_REGISTERED \
	"Forbidden - HSS Identity not registered"
...
#define MSG_480_NOT_REGISTERED \
	"Temporarily Unavailable - HSS Identity not registered"

#define MSG_500_ERROR_SAVING_LIST \
	"Server Error while saving S-CSCF list on I-CSCF"
...
#define MSG_600_FORWARDING_FAILED \

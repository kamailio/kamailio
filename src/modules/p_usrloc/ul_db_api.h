...
typedef int (*ul_db_insert_t)(str *table, str *first, str *second, db_key_t *_k,
		db_val_t *_v, int _n);

typedef int (*ul_db_update_t)(str *table, str *first, str *second, db_key_t *_k,
...
typedef int (*ul_db_delete_t)(str *table, str *first, str *second, db_key_t *_k,
		db_op_t *_o, db_val_t *_v, int _n);

typedef int (*ul_db_query_t)(str *table, str *first, str *second,
		db1_con_t ***_r_h, db_key_t *_k, db_op_t *_op, db_val_t *_v,

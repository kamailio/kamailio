...
int kz_amqp_query_3(struct sip_msg *msg, char *exchange, char *routing_key, char *payload);
int kz_amqp_query_4(struct sip_msg *msg, char *exchange, char *routing_key, char *payload, str *dst);
int kz_amqp_query_5(struct sip_msg *msg, char *exchange, char *routing_key, char *payload, str *dst, char *headers);
...
int kz_amqp_subscribe_simple(struct sip_msg *msg, char *exchange,
		char *exchange_type, char *queue_name, char *routing_key);
int kz_amqp_encode(struct sip_msg *msg, char *unencoded, char *encoded);
int kz_amqp_encode_ex(str *unencoded, pv_value_p dst_val);

int kz_amqp_async_query(struct sip_msg *msg, char *exchange, char *routing_key,
		char *payload, char *_cb_route, char *_err_route);

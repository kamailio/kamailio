...
static void rpc_stats(rpc_t *rpc, void *c)
{
	...
	rpc->struct_add(st, "ddd", "200", total.err[RT_200], "202",
			total.err[RT_202], "2xx", total.err[RT_2xx]);

	rpc->struct_add(st, "dddd", "300", total.err[RT_300], "301",
			total.err[RT_301], "302", total.err[RT_302], "3xx",
			total.err[RT_3xx]);

	rpc->struct_add(st, "dddddddd", "400", total.err[RT_400], "401",
	...
	rpc->struct_add(
			st, "dd", "500", total.err[RT_500], "5xx", total.err[RT_5xx]);

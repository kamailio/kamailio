	...
	for(i = 0; i < SR_KEMI_PARAMS_MAX; i++) {
		if(ket->ptypes[i] == SR_KEMIP_NONE) {
			...
			LM_DBG("param[%d] for: %.*s.%.*s is str: %.*s\n", i, mname->len,
					mname->s, fname->len, fname->s, vps[i].s.len, vps[i].s.s);
			...
			LM_DBG("param[%d] for: %.*s.%.*s is int: %d\n", i, mname->len,
					mname->s, fname->len, fname->s, vps[i].n);
		} else {
	...
	switch(i) {
			...
			if(ket->ptypes[0] == SR_KEMIP_STR && ket->ptypes[1] == SR_KEMIP_STR
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmsss_f)(ket->func))(
							env_R->msg, &vps[0].s, &vps[1].s, &vps[2].s);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmssn_f)(ket->func))(
							env_R->msg, &vps[0].s, &vps[1].s, vps[2].n);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmsns_f)(ket->func))(
							env_R->msg, &vps[0].s, vps[1].n, &vps[2].s);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmsnn_f)(ket->func))(
							env_R->msg, &vps[0].s, vps[1].n, vps[2].n);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmnss_f)(ket->func))(
							env_R->msg, vps[0].n, &vps[1].s, &vps[2].s);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmnsn_f)(ket->func))(
							env_R->msg, vps[0].n, &vps[1].s, vps[2].n);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmnns_f)(ket->func))(
							env_R->msg, vps[0].n, vps[1].n, &vps[2].s);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
				...
				if(ket->rtype == SR_KEMIP_XVAL) {
					xret = ((sr_kemi_xfmnnn_f)(ket->func))(
							env_R->msg, vps[0].n, vps[1].n, vps[2].n);
					return sr_kemi_ruby_return_xval(ket, xret);
				} else {
		...
		case 4:
			if(ket->ptypes[0] == SR_KEMIP_STR && ket->ptypes[1] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmssss_f)(ket->func))(
						env_R->msg, &vps[0].s, &vps[1].s, &vps[2].s, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmsssn_f)(ket->func))(
						env_R->msg, &vps[0].s, &vps[1].s, &vps[2].s, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmssns_f)(ket->func))(
						env_R->msg, &vps[0].s, &vps[1].s, vps[2].n, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmssnn_f)(ket->func))(
						env_R->msg, &vps[0].s, &vps[1].s, vps[2].n, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmsnss_f)(ket->func))(
						env_R->msg, &vps[0].s, vps[1].n, &vps[2].s, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmsnsn_f)(ket->func))(
						env_R->msg, &vps[0].s, vps[1].n, &vps[2].s, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmsnns_f)(ket->func))(
						env_R->msg, &vps[0].s, vps[1].n, vps[2].n, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_STR
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmsnnn_f)(ket->func))(
						env_R->msg, &vps[0].s, vps[1].n, vps[2].n, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmnsss_f)(ket->func))(
						env_R->msg, vps[0].n, &vps[1].s, &vps[2].s, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmnssn_f)(ket->func))(
						env_R->msg, vps[0].n, &vps[1].s, &vps[2].s, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmnsns_f)(ket->func))(
						env_R->msg, vps[0].n, &vps[1].s, vps[2].n, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmnsnn_f)(ket->func))(
						env_R->msg, vps[0].n, &vps[1].s, vps[2].n, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmnnss_f)(ket->func))(
						env_R->msg, vps[0].n, vps[1].n, &vps[2].s, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmnnsn_f)(ket->func))(
						env_R->msg, vps[0].n, vps[1].n, &vps[2].s, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmnnns_f)(ket->func))(
						env_R->msg, vps[0].n, vps[1].n, vps[2].n, &vps[3].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  && ket->ptypes[2] == SR_KEMIP_INT
				...
				ret = ((sr_kemi_fmnnnn_f)(ket->func))(
						env_R->msg, vps[0].n, vps[1].n, vps[2].n, vps[3].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else {
				LM_ERR("invalid parameters for: %.*s\n", fname->len, fname->s);
				return Qfalse;
		...
		case 5:
			if(ket->ptypes[0] == SR_KEMIP_STR && ket->ptypes[1] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmsssss_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				ret = ((sr_kemi_fmssssn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmsssns_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmsssnn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmssnss_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmssnsn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmssnns_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmssnnn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmsnsss_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmsnssn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmsnsns_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmsnsnn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmsnnss_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmsnnsn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmsnnns_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmsnnnn_f)(ket->func))(env_R->msg, &vps[0].s,
				...
				return sr_kemi_ruby_return_int(ket, ret);
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnssss_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, &vps[2].s, &vps[3].s, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnsssn_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, &vps[2].s, &vps[3].s, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnssns_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, &vps[2].s, vps[3].n, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnssnn_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, &vps[2].s, vps[3].n, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnsnss_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, vps[2].n, &vps[3].s, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnsnsn_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, vps[2].n, &vps[3].s, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnsnns_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, vps[2].n, vps[3].n, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_STR
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnsnnn_f)(ket->func))(env_R->msg, vps[0].n,
						&vps[1].s, vps[2].n, vps[3].n, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnnsss_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, &vps[2].s, &vps[3].s, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnnssn_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, &vps[2].s, &vps[3].s, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnnsns_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, &vps[2].s, vps[3].n, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnnsnn_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, &vps[2].s, vps[3].n, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnnnss_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, vps[2].n, &vps[3].s, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_STR
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnnnsn_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, vps[2].n, &vps[3].s, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_STR) {
				ret = ((sr_kemi_fmnnnns_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, vps[2].n, vps[3].n, &vps[4].s);
				return sr_kemi_ruby_return_int(ket, ret);
			} else if(ket->ptypes[0] == SR_KEMIP_INT
					  && ket->ptypes[1] == SR_KEMIP_INT
					  ...
					  && ket->ptypes[3] == SR_KEMIP_INT
					  && ket->ptypes[4] == SR_KEMIP_INT) {
				ret = ((sr_kemi_fmnnnnn_f)(ket->func))(env_R->msg, vps[0].n,
						vps[1].n, vps[2].n, vps[3].n, vps[4].n);
				return sr_kemi_ruby_return_int(ket, ret);
			} else {
				LM_ERR("invalid parameters for: %.*s\n", fname->len, fname->s);
		...
		case 6:
			if(ket->ptypes[0] == SR_KEMIP_STR && ket->ptypes[1] == SR_KEMIP_STR
				...
				ret = ((sr_kemi_fmssssss_f)(ket->func))(env_R->msg, &vps[0].s,
...
static void app_ruby_rpc_reload(rpc_t *rpc, void *ctx)
{
	...
	*_sr_ruby_reload_version += 1;
	...
	rpc->struct_add(vh, "dd", "old", v, "new", *_sr_ruby_reload_version);
}

static const char *app_ruby_rpc_api_list_doc[2] = {
		"List kemi exports to ruby", 0};
...
rpc_export_t app_ruby_rpc_cmds[] = {
		{"app_ruby.reload", app_ruby_rpc_reload, app_ruby_rpc_reload_doc, 0},
		{"app_ruby.api_list", app_ruby_rpc_api_list, app_ruby_rpc_api_list_doc,
				0},
		{0, 0, 0, 0}};

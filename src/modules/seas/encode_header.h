...
#include "../../core/str.h"
int print_encoded_header(FILE *fd, char *msg, int len, unsigned char *payload,
		int paylen, char type, char *prefix);
int encode_header(struct sip_msg *msg, struct hdr_field *hdr,

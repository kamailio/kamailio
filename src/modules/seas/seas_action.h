...
int ac_uac_req(as_p the_as, unsigned char processor_id, unsigned int flags,
		char *action, int len);
int ac_encode_msg(as_p the_as, unsigned char processor_id, unsigned int flags,
		char *action, int len);
...
int extract_allowed_headers(struct sip_msg *my_msg, int allow_vias,
		int allow_Rroutes, hdr_flags_t forbidden_hdrs, char *headers,
		int headers_len);

...
sc fifo t_uac_dlg MESSAGE sip:joe@192.168.2.1 \
	. \ # no outbound proxy
	'From:sender@sip.org;tagd=123'  \ # no to-tag -> ephemeral
	'To:sender@sip.org' \
...
To: sender@sip.org..
From: sender@sip.org;tagd=123;tag=5405e669bc2980663aed2624dc31396f-fa77..
CSeq: 11 MESSAGE..
Call-ID: e863bf56-22255@192.168.2.16..
Content-Length: 0..
User-Agent: OpenSer (0.9.2 (i386/linux))..

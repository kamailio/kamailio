 ...
 */
void ospRecordOrigTransaction(struct sip_msg* msg, unsigned long long trans, char* uac, char* from, char* to, time_t authtime, unsigned destinationCount);
void ospRecordTermTransaction(struct sip_msg* msg, unsigned long long trans, char* uac, char* from, char* to, time_t authtime);

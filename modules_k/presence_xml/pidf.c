...
int bind_libxml_api(libxml_api_t* api)
{
	...
	api->xmlDocGetNodeByName = (xmlDocGetNodeByName_t )find_export
		("xmlDocGetNodeByName", 1, 0);
	if (api->xmlDocGetNodeByName == 0)
	{
		LOG(L_ERR, "PRESENCE_XML:bind_libxml: Can't bind xmlDocGetNodeByName\n");
		return -1;
	}
	...
	api->xmlNodeGetNodeContentByName= ( xmlNodeGetNodeContentByName_t)find_export
		("xmlNodeGetNodeContentByName", 1, 0);
	if (api->xmlNodeGetNodeContentByName == 0)
	{
		LOG(L_ERR, "PRESENCE_XML:bind_libxml: Can't bind xmlNodeGetNodeContentByName\n");
		return -1;
	}
	
	api->xmlNodeGetAttrContentByName= (xmlNodeGetAttrContentByName_t )find_export
		("xmlNodeGetAttrContentByName", 1, 0);
	if (api->xmlNodeGetAttrContentByName == 0)
	{
		LOG(L_ERR, "PRESENCE_XML:bind_libxml: Can't bind xmlNodeGetAttrContentByName\n");
		return -1;
	}

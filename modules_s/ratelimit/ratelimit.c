 ...
 * ratelimit module
 *
 * This modules tracks the number of requests traversing SER and allows
 * dropping of packets if a given threshold is reached.
 * Two algorithms are implemented: a trivial tail drop one and a probably
 * better Random Early Detection (RED) based.
 *
 * define RL_WITH_RED if you like to use the RED algorithm (default)
 *
...
#include "../../parser/parse_methods.c"
